...
<body>
	...
	<div class="navbar-top">
		...
		<div class="site-brand">
			<a href="{{ url('index/index/index') }}"><h1>微商城</h1></a>
		</div>
		<!-- end site brand	 -->
	...
	<div class="side-nav-panel-right">
		<ul id="slide-out-right" class="side-nav side-nav-panel collapsible">
			...
			<li><a href="{{ url('index/login/login') }}"><i class="fa fa-sign-in"></i>登录</a></li>
			<li><a href="{{ url('index/login/register') }}"><i class="fa fa-user-plus"></i>注册</a></li>
		</ul>
	</div>
	<!-- end side nav right-->
	@else
	...
	<div class="side-nav-panel-right">
		<ul id="slide-out-right" class="side-nav side-nav-panel collapsible">
			<li class="profil">
				<img src="{{ asset('storage/icon/icon3.jpg') }}" alt="">
				<h2>{{ session('user_name') }}</h2>
			</li>
			<li><a href="{{ url('index/cart/list') }}"><i class="fa fa-shopping-cart"></i>查看购物车</a></li>
			<li><a href="setting.html"><i class="fa fa-cog"></i>设置</a></li>
			<li><a href="about-us.html"><i class="fa fa-user"></i>简介</a></li>
			<li><a href="contact.html"><i class="fa fa-envelope-o"></i>消息</a></li>
			<li><a href="{{ url('index/login/logout') }}"><i class="fa fa-sign-in"></i>退出</a></li>
			<li><a href="{{ url('index/login/register') }}"><i class="fa fa-user-plus"></i>注册</a></li>
		</ul>
	</div>
	<!-- end side nav right-->
